    ...
    <nav className="bg-white border-b-2 w-full p-4">
      <div className="flex justify-between items-center max-w-5xl mx-auto">
        ...
        <div className="flex space-x-4">
          <a href="/" className="text-gray-800 hover:bg-gray-100">Beranda</a>
          <a href="/library" className="text-gray-800 hover:bg-gray-100">Library</a>
          <a href="/novel" className="text-gray-800 hover:bg-gray-100">Novel</a>
        </div>
        <div className="flex items-center space-x-4">
          ...
          <div className="relative">
            ...
            {dropdownOpen && (
              ...
              <div class="border-b-2 shadow-md px-4 py-3 text-sm text-gray-900">
